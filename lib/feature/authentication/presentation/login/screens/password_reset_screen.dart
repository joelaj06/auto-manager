...
import 'package:automanager/core/presentation/presentation.dart';
      ...
      body: SafeArea(
        child: Container(
          ...
          child: PageView(
            ...
            children: <Widget>[
              PlatformWidget(
                mobile: _buildResetInfoScreen(context),
                web: Center(
                  child: Container(
                    ...
                    child: _buildResetInfoScreen(context),
                  ),
                ),
              ),
              PlatformWidget(
                mobile: _buildOtpVerificationPage(context),
                web: Center(
                  child: Padding(
                    padding:  AppPaddings.bodyV,
                    child: SizedBox(
                      child: IntrinsicHeight(
                        child: Container(
                          ...
                          width: context.width /3,
                          child:  _buildOtpVerificationPage(context),
                        ),
                      ),
                    ),
                  ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Obx(
              () => AppButton(
                text: 'Continue',
                padding: kIsWeb ? AppPaddings.mA: null,
                // fontSize: 18,
